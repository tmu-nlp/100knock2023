...
train = pd.read_csv('./song/chapter06/train.txt', header=None, sep='\t') 
valid = pd.read_csv('./song/chapter06/valid.txt', header=None, sep='\t') 
test = pd.read_csv('./song/chapter06/test.txt', header=None, sep='\t') 
