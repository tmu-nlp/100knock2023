...
# 2. 事例の抽出
news_corpora = pd.read_csv('./song/chapter06/newsCorpora.csv',sep='\t',header=None)
...
train_df.to_csv('./song/chapter06/train.txt', columns = ['CATEGORY','TITLE'], sep='\t',header=False, index=False)
valid_df.to_csv('./song/chapter06/valid.txt', columns = ['CATEGORY','TITLE'], sep='\t',header=False, index=False)
test_df.to_csv('./song/chapter06/test.txt', columns = ['CATEGORY','TITLE'], sep='\t',header=False, index=False)
